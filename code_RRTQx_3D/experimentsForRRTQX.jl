...
function sim_RRTQX()
  ...
  #Video 2
  #start = [-14.9 13.5 -7.5] # [-40.0 40.0 10.0]    # robot comes from here (goal location of search tree) [-18.0 18.0 10.0]
  #goal = [7.0 -16.5 -7.5] # 5*[0.0 -8.0 10.0]   # robot goes to here (start location of search tree) [15.0 -10.0]
  #start2 = [17.5 12.0 -6.5] # 5*[0.0 -8.0]   # robot goes to here (start location of search tree) [15.0 -10.0]
  #goal2 = [-14.3 -8.5 -6.5] # [-40.0 40.0 10.0]    # robot comes from here (goal location of search tree) [-18.0 18.0 10.0]
  #start3 = [12.5 -13.0 -6.0] # 5*[0.0 -8.0 10.0]   # robot goes to here (start location of search tree) [15.0 -10.0 10.0]
  #goal3 = [-8.5 16.5 -6.0] # [-40.0 40.0 10.0]    # robot comes from here (goal location of search tree) [-18.0 18.0 10.0]
  #start4 = [3.5 15.0 -6.0] # 5*[0.0 -8.0 10.0]   # robot goes to here (start location of search tree) [15.0 -10.0 10.0]
  #goal4 = [1.5 -14.5 -6.0] # [-40.0 40.0 10.0]    # robot comes from here (goal location of search tree) [-18.0 18.0 10.0]
  #Video 3
  start = [-15.9 -0.5 -5.5] # [-40.0 40.0 10.0]    # robot comes from here (goal location of search tree) [-18.0 18.0 10.0]
  goal = [16.0 1.5 -5.5] # 5*[0.0 -8.0 10.0]   # robot goes to here (start location of search tree) [15.0 -10.0]
  start2 = [16.5 2.5 -5.5] # 5*[0.0 -8.0]   # robot goes to here (start location of search tree) [15.0 -10.0]
  goal2 = [-15.3 -1.5 -5.5] # [-40.0 40.0 10.0]    # robot comes from here (goal location of search tree) [-18.0 18.0 10.0]
  start3 = [-2.5 -1.0 -5.0] # 5*[0.0 -8.0 10.0]   # robot goes to here (start location of search tree) [15.0 -10.0 10.0]
  goal3 = [1.5 1.5 -5.0] # [-40.0 40.0 10.0]    # robot comes from hecre (goal location of search tree) [-18.0 18.0 10.0]
  start4 = [2.5 1.0 -6.0] # 5*[0.0 -8.0 10.0]   # robot goes to here (start location of search tree) [15.0 -10.0 10.0]
  goal4 = [-1.5 -2.5 -6.0] # [-40.0 40.0 10.0]    # robot comes from here (goal location of search tree) [-18.0 18.0 10.0]
